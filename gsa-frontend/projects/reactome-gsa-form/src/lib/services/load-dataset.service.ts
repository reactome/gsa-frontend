...
export class LoadDatasetService {
  // stepper: MatStepper;
  loadDataUrl = `${this.config.apiRoot}/data/load/`;
  loadingStatusUrl = `${this.config.apiRoot}/data/status/`;
  summaryDataUrl = `${this.config.apiRoot}/data/summary/`;
  uploadDataUrl = `${this.config.apiSecretRoot}/upload`;
